...
# ===== DIRECT RAW LINKS (CORRECT FORMAT) =====
...
# Hide Streamlit’s default UI and inject the player
st.markdown(
    """
    <style>
...
# Critical: use st.markdown with unsafe_allow_html=True to render the video player
