...
# ========== FULL HTML/JS CODE (AS A RAW STRING) ==========
html_code = """
<!DOCTYPE html>
<html>
<head>
...
<body>
    ...
    <div id="video1Container" class="video-container">
        <video id="player1" autoplay muted playsinline>
            <source src="https://raw.githubusercontent.com/Deslandes1/Nic-Honestly-Crafted-Ice-creams/main/dreamina-2026-04-29-5258-make%20the%20different%20flavor%20ice%20creams%20mov....mp4" type="video/mp4">
        </video>
    </div>
    ...
    <div id="video2Container" class="video-container" style="display: none;">
        <video id="player2" muted playsinline>
            <source src="https://raw.githubusercontent.com/Deslandes1/Nic-Honestly-Crafted-Ice-creams/main/dreamina-2026-04-29-3384-his%20writing%20must%20passing%20by%20as%20a%20slidesh....mp4" type="video/mp4">
        </video>
    </div>

    <!-- Image 3 (static) -->
    <div id="imageContainer" class="image-container" style="display: none;">
        <img id="staticImage" src="https://raw.githubusercontent.com/Deslandes1/Nic-Honestly-Crafted-Ice-creams/main/NIC%205.png" alt="NIC Ice Creams">
    </div>

    <!-- Video 4 (final) -->
    <div id="video4Container" class="video-container" style="display: none;">
        <video id="player4" muted playsinline>
            <source src="https://raw.githubusercontent.com/Deslandes1/Nic-Honestly-Crafted-Ice-creams/main/NIC6a.mp4" type="video/mp4">
        </video>
    </div>
...
# CRITICAL: Render the HTML/JS as a live webpage, not as raw text
